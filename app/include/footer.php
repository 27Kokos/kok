 <!-- # site-footer
        ...
        <footer id="footer" class="s-footer target-section" >
            ...
            <div class="row section-header" data-num="03">
                <h3 class="column lg-12 section-header__pretitle text-pretitle">CВЯЗАТЬСЯ</h3>
                <div class="column lg-6 stack-on-1100 section-header__primary">
                    <h2 class="title text-display-1">
                    У вас есть идея или грандиозный проект на примете? Поговори с нами. 
                    Давайте работать вместе и создадим что-нибудь замечательное. 
                    Напишите нам по адресу <a href="mailto:#0" title="">Shemetovvlados@gmail.com</a>
                    </h2>
                </div>    
                <div class="column lg-6 stack-on-1100 section-header__secondary">
                    ...
                    <div class="contact-block">
                        <h6>Где нас найти</h6>
                        <p>
                        У нас нет своих точек <br>
                        Но мы находимся в городе <br>
                        Санкт-Петербург
                        </p>
                    </div>

                    <div class="contact-block">
                        <h6>Номера для связи</h6>
                        <ul class="contact-list">
                            <li><a href="tel:197-543-2345">+7(962-382-99-32)</a></li>
                            <li><a href="tel:197-123-9876">+7(921-928-58-59)</a></li>
                        </ul>
                    </div>
            ...
            <div class="row s-footer__bottom">
                ...
                <div class="column lg-6 tab-12 s-footer__bottom-left">
                    <ul class="s-footer__social">
                        ...
                        <li>
                            <a href="https://twitter.com/KokosikNft" target="_blank">
                ...
                <div class="column lg-6 tab-12 s-footer__bottom-right">
                    <div class="ss-copyright">
                        <span>© Kokodjambo 2023</span> 
                        <span>Design by <a href="https://www.styleshout.com/">Vlasha</a></span>
                    </div>
                </div>
